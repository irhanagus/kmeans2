  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Iterasi 4</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Imp. K-Means</li>
              <li class="breadcrumb-item active">Iterasi 4</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
        ...
        <div class="card card-info card-outline">
            <h4 class="m-0"><center>Iterasi 4</center></h4>
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('iterasi5')}}" class="btn btn-primary">Lanjutkan</a>
                </center>
            </div>
        </div>
    </div>
