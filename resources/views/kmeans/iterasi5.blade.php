...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Iterasi 5</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
        ...
        <div class="card card-info card-outline">
            <h4 class="m-0"><center>Iterasi 5</center></h4>
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                <center>
                <p class="card-text">Iterasi berakhir di sini</p>
                </center>
            </div>
        </div>
    </div>
